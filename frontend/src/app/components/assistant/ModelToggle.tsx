...
export const MODELS: ModelOption[] = [
    ...
    { id: "localllm-main", label: "Local Model (Main)", group: "Local" },
    { id: "localllm-light", label: "Local Model (Light)", group: "Local" },
];
...
const GROUP_ORDER: ModelOption["group"][] = ["Anthropic", "Google", "Local"];
